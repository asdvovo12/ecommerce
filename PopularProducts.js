// PopularProductsScreen.js (Create this new file)
...
const PopularProductsScreen = () => {
    ...
    const screenTitle = t('popularProducts'); // Use translation for title
    ...
    useFocusEffect(
        React.useCallback(() => {
            loadPreferences();
            // Get products from route.params
                    ...
                    {products.map((product) => (
                        ...
                        >
                            ...
                            <TouchableOpacity
                                ...
                                onPress={(event) => {
                                    event.stopPropagation(); // Prevent navigation when tapping the heart
